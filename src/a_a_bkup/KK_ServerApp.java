...
//	private ArrayList<ClientThread> clientArrayList;
	 ...
	 *  in console
	 */
	public KK_ServerApp(int port) {
		
		this(port, null);
		System.out.println("Server.java constructor port :" + port);
	}
	
	public KK_ServerApp(int port, KK_ServerAppGUI sg) {	// 
		// GUI or not
		this.sg = sg;
		// the port
		this.port = port;
...
//				}
	...
	public void serverConnection() throws IOException {
		...
		try {
			serverSocket = new ServerSocket(port); 	// 4444
...
//			catch (Exception e) {}
		 ...
		 */
		//TODO: don't know if this is being used, needs further testing
